...
/**
 * Radix's `Slot` component struggles to play nicely with nested children:
 * https://github.com/radix-ui/primitives/issues/1825
 *
 * A PR was raised to address this issue, however it still hasn't been accepted.
 * The code below was copied verbatim from this PR:
 * https://github.com/radix-ui/primitives/pull/2197
 */

import * as React from "react"

import { composeRef } from "@/src/util/compose-ref"
